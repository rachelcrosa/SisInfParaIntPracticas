...
CREATE TABLE ARTICULO (ID BIGINT NOT NULL, ANIO INTEGER, NUMERO INTEGER, PAGINAFINAL INTEGER, PAGINAINICIAL INTEGER, PUBLICACIONES VARCHAR(255), TITULO VARCHAR(255), VOLUMEN INTEGER, PRIMARY KEY (ID))
